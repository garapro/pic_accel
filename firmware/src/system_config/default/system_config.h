...
#define INT1StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_4)

/*** Functions for INT2 pin ***/
#define INT2StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_5)

/*** Functions for DRDY pin ***/
#define DRDYStateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_6)


/*** Application Instance 0 Configuration ***/

#define PIC_ACCEL_USB_CDC_COM_PORT_SINGLE_WRITE_BUFFER_SIZE 512
